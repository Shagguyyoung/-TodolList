 ...
 localStorage.setItem("todo", JSON.stringify(todoList))
  ...
  return (
    <div className='bg-white place-self-center w-11/12 max-w-md
     flex flex-col p-7 min-h-137.5 rounded-xl shadow-lg shadow-amber-50'>

        {/* --------Title---------- */}

      <div className='flex items-center mt-7 gap-2'>
        <img className='w-8' src={add_box} alt="" />
      ...
      <div className='flex items-center my-7 bg-gray-200 rounded-full'>
         ...
         flex-1 h-14 pl-6 pr-2 placeholder:text-slate-60' type="text" placeholder='Ajouter une tâche' />
         <button onClick={add} className='border-none rounded-full
          bg-orange-600 w-30 h-14 text-white text-lg font-medium
          cursor-pointer'>Ajuoter +</button>
      </div>
